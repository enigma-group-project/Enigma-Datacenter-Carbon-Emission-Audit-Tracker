...
contract InvariantTest is Test {
    ...
    /// @dev Authorization property: a non-Auditor can NEVER issue, for any inputs.
    function testFuzz_OnlyTestCenterCanIssue(address caller, bytes32 id, bytes32 h, address owner_) public {
        ...
        vm.assume(!issuers.isAuditor(caller));
        vm.prank(caller);
        vm.expectRevert(RecordRegistry.NotAuditor.selector);
        records.recordEmissionReport(id, h, "cid", owner_, "meta");
    }
