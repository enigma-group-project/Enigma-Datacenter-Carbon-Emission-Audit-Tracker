# Enigma-Datacenter-Carbon-Emission-Audit-Tracker
...
> Team Enigma (Group E) · CS-GY 9215 Applied Blockchain · **Scenario:** Data-center carbon-emission audit: accredited auditors anchor tamper-evident emission-evidence hashes so a regulator can verify a data center's reported carbon footprint without trusting a central database.
...
- 🌐 **Live GUI (GitHub Pages):** <https://enigma-group-project.github.io/Enigma-Datacenter-Carbon-Emission-Audit-Tracker/>
...
- 📊 **Tracker:** <https://enigma-group-project.github.io/Enigma-Datacenter-Carbon-Emission-Audit-Tracker/tracker/>
...
|---|-------|----------|-----------------|---------------|---------------|
| 1 | Auditor Registration | `contracts/IssuerRegistry.sol` | `forge test --match-contract IssuerRegistryTest` | `frontend/src/modules/issuer/` | `registerAuditor · deregisterAuditor · transferComplianceOfficer` |
| 2 | Emission Report Recording | `contracts/RecordRegistry.sol` | `forge test --match-contract RecordRegistryTest` | `frontend/src/modules/record/` | `recordEmissionReport` |
...
|------|-----|-------------|
| Issuer | Accredited Auditor | create / update / revoke CarbonRecord |
| Owner | Data-Center Operator | transfer their own CarbonRecord |
| Verifier | Regulator/Registry | read-only verification |
...
|--------|-------------|--------|----------|
| member1 | Auditor Registration (`IssuerRegistry`) | `feature/member1-issuer-registration` | _screenshot / test output_ |
