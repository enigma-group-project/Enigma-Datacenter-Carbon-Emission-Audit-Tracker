...
contract Verification {
    ...
    function verifyEmissionReportHash(bytes32 id, bytes32 candidateHash) public view returns (bool) { return false; /* TODO(member3) */ }
    function verifyEmissionReport(bytes32 id, bytes32 candidateHash) external view returns (bool valid, IAttestationRegistry.Status status, address owner, address issuer) {
