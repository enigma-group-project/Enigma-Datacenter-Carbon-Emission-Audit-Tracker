...
contract Verification {
    ...
    function verifyEmissionReportHash(bytes32 id, bytes32 candidateHash) public view returns (bool) {
        // TODO(member3): return registry.getRecord(id).dataHash == candidateHash;
        return false;
    }
    /// @notice One-call verification for the frontend.
    function verifyEmissionReport(bytes32 id, bytes32 candidateHash)
